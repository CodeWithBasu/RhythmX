    ...
    <div className="min-h-screen flex flex-col bg-[#0C0414]">
      ...
      <main className="flex-1 flex items-center justify-center pt-24 pb-12 px-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-[1000px] grid lg:grid-cols-2 gap-12 lg:gap-24 items-center z-10">
          ...
          <div className="flex flex-col gap-6 p-8 rounded-2xl bg-[#130820]/80 backdrop-blur-xl border border-white/10 shadow-[0_0_40px_rgba(192,132,252,0.1)] order-1 lg:order-2">
            ...
            <div className="relative flex items-center py-2">
              ...
              <span className="flex-shrink-0 mx-4 text-white/40 text-sm">Or sign up with</span>
              <div className="flex-grow border-t border-white/10"></div>
            </div>
            ...
            <p className="text-center text-sm text-white/60 mt-4">
              ...
              <Link href="/signin" className="text-[#C084FC] font-medium hover:underline">
                Sign in
              </Link>
            </p>
          </div>
