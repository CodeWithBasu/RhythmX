    ...
    <footer className="w-full bg-[#0C0414] text-white py-12 px-6 md:px-12 relative z-20 border-t border-white/5 font-sans overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col gap-16 md:gap-24">
        ...
        >
          ...
          <h2 
            className="text-[19vw] sm:text-[18vw] md:text-[15vw] leading-none font-bold tracking-tighter relative z-10"
            style={{
          ...
          <h2 
            className="hidden md:flex absolute inset-0 items-center justify-center text-[19vw] sm:text-[18vw] md:text-[15vw] leading-none font-bold tracking-tighter z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"
            style={{
          ...
          <h2 
            className="md:hidden absolute inset-0 flex items-center justify-center text-[19vw] sm:text-[18vw] md:text-[15vw] leading-none font-bold tracking-tighter z-20 pointer-events-none mobile-shine-text"
            style={{
              WebkitTextStroke: '2px rgba(192,132,252,0.5)',
              WebkitMaskImage: 'linear-gradient(to bottom, black 40%, transparent 100%)',
              maskImage: 'linear-gradient(to bottom, black 40%, transparent 100%)',
