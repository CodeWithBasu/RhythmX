...
export function ContactSection() {
	return (
		<main className="relative flex size-full w-full items-center justify-center p-4 py-20 z-10">
			<div className="mx-auto w-full max-w-6xl">
				<ContactCard
					title="GET IN TOUCH"
					description="Have a question about the RhythmX Sonic Reality Engine? Want to report a bug or request a feature? Drop us a message below and we'll get back to you immediately."
					contactInfo={[
						{
							icon: MailIcon,
							label: 'Email',
							value: 'basudevmuna111@gmail.com',
						},
						{
							icon: DiscordIcon,
							label: 'Discord',
							value: 'basudev0666',
							iconColor: 'text-[#5865F2]', // Discord branding color
						},
						{
							icon: Earth,
							label: 'Location',
							value: 'Cuttack, Odisha, India',
							iconColor: 'text-green-500', // Green earth logo
						}
					]}
				>
